...
def parse_args():
    ...
    parser.add_argument(
        '--a_fold', type=int, default=100, help="the fold num used to split large adj matrix, like gowalla"
    )
    parser.add_argument('--testbatch', type=int, default=100, help="the batch size of users for testing")
    parser.add_argument(
        '--dataset', type=str, default='gowalla', help="available datasets: [lastfm, gowalla, yelp2018, amazon-book]"
    )
    parser.add_argument('--checkpoint_path', type=str, default="./checkpoints", help="path to save weights")
    parser.add_argument('--results_path', type=str, default="./results", help="path to save weights")
    ...
    parser.add_argument('--model', type=str, default='lgn', help='rec-model, support [mf, lgn, ugn]')
